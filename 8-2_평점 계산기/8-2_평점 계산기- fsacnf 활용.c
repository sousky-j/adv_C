...
void main()
{
	...
	for (int i = 0; i < 7; i++)
	{
		...
		if (strcmp(sungjuk[i], "A+") == 0) score[i] = std_score[0];
		else if (strcmp(sungjuk[i], "A") == 0) score[i] = std_score[1];
		else if (strcmp(sungjuk[i], "B+") == 0) score[i] = std_score[2];
		else if (strcmp(sungjuk[i], "B0") == 0) score[i] = std_score[3];
		else if (strcmp(sungjuk[i], "C+") == 0) score[i] = std_score[4];
		else if (strcmp(sungjuk[i], "C0") == 0) score[i] = std_score[5];
		else if (strcmp(sungjuk[i], "D+") == 0) score[i] = std_score[6];
		else if (strcmp(sungjuk[i], "D0") == 0) score[i] = std_score[7];
		else if (strcmp(sungjuk[i], "F") == 0) score[i] = std_score[8];
